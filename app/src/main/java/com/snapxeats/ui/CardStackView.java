...
/**
 * Created by Prajakta Patil on 14/3/18.
 */
public class CardStackView  extends FrameLayout {
    ...
    private void moveToBottom(CardContainerView container) {
        com.yuyakaido.android.cardstackview.CardStackView parent = (com.yuyakaido.android.cardstackview.CardStackView) container.getParent();
        if (parent != null) {
