...
@Getter
@Setter
public class Cuisines implements Parcelable, Comparable<Cuisines> {
    ...
    @Override
    public int compareTo(@NonNull Cuisines cuisine) {
        return this.cuisine_name.compareTo(cuisine.getCuisine_name());
    }
}
