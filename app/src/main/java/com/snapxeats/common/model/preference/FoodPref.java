...
@Getter
@Setter
public class FoodPref implements Parcelable,Comparable<FoodPref> {
    ...
    @Override
    public int compareTo(@NonNull FoodPref foodPref) {
        return this.getFood_name().compareTo(foodPref.getFood_name());
    }
}
