...
public class SnapXDraftPhoto {
    ...
    @Generated(hash = 9189185)
    public SnapXDraftPhoto(String smartPhoto_Draft_Stored_id, String restaurantName,
            String imageURL, String audioURL, String textReview, int rating) {
    ...
    public List<RestaurantAminities> getRestaurant_aminities() {
        if (restaurant_aminities == null) {
            ...
            List<RestaurantAminities> restaurant_aminitiesNew = targetDao
                    ._querySnapXDraftPhoto_Restaurant_aminities(
                            smartPhoto_Draft_Stored_id);
            synchronized (this) {
                if (restaurant_aminities == null) {
